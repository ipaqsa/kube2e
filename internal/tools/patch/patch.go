// Package patch applies RFC 6902 JSON Patch operations to Kubernetes objects.
package patch
...
// Patches is an ordered list of RFC 6902 patch operations.
type Patches []Patch
...
// returns the patched object decoded back into an Unstructured. When opts is
// nil the library defaults are used.
